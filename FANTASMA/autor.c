...
*
*/
int autor_Inicializar(Autor array[], int size)    
{
    int retorno=-1;
...
*
*/
int autor_modificar(Autor array[], int sizeArray)                           
{
    int retorno=-1;
    int posicion;
    int id;                                                                                       
...
*
*/
int autor_ordenarPorDobleCriterio(Autor array[],int size, int orderFirst, int orderSecond) 
{
    int retorno=-1;
    int i;
    Autor buffer;
...
void autor_mock(Autor arrayAutor[], int size,int *contadorIdAutor)   
{
